            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body" style="padding: 8px 12px;">
                           ...
                           <h4 style="padding-top:10px; margin-bottom:5px;" class="card-title">Manage Email Engine</h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card" >
                            <div class="card-body" style=" min-height: 500px;"> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <select name="email_engine_id" class="form-select">
                                                <option>Select</option>
                                                <?php 
                                                    foreach ($email_engine as $ee) {
                                                            $sel ='';
                                                            if($ee->is_default == 1){
                                                                $sel ='SELECTED';
                                                            }
                                                       ?>
                                                       <option <?=$sel ?> value="<?=$ee->id ?>"><?=$ee->name ?></option>
                                                       <?php
                                                    }
                                                ?>
