                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                ...
                                <li class="breadcrumb__content--menu__items"><span style="color:white;">Blog Details</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="blog__details--wrapper">
                            <div class="entry__blog">
                                <div class="blog__post--header mb-30">
                                    ...
                                    <p class="blog__post--meta">Posted by : admin / On : May 26, 2022 / In : <a class="blog__post--meta__link" href="blog-details.php">Company, Image, Travel</a></p>                                     
                                </div>
