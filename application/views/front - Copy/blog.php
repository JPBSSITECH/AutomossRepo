                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title mb-25" style="color: white;">Blogs</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a href="<?= base_url()?>"style="color: white;">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span style="color: white;">Blogs</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="blog__section--inner">
                    <div class="row mb--n30">
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog__card">
                                ...
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="<?= base_url()?>blog_details.php">Beauty Skin Care Product In Stock</a></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="<?= base_url()?>blog_details"><img class="blog__card--thumbnail__img" src="assets/img/blog/blog4.webp" alt="blog-img"></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="<?= base_url()?>blog_details"><img class="blog__card--thumbnail__img" src="assets/img/blog/blog5.webp" alt="blog-img"></a>
                                    <span class="blog__card--meta__date">20 <br> Oct</span>  
                                </div>
                                <div class="blog__card--content">
                                    <span class="blog__card--meta">By: Rasalina</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="<?= base_url()?>blog_details"><img class="blog__card--thumbnail__img" src="assets/img/blog/blog6.webp" alt="blog-img"></a>
