                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title mb-25 text-white">Cars</h1>
          ...
          <div class="container">
            <div class="row mt-5">
                ...
                <div class="group-form pb-4" style="border-bottom: 2px solid #eee;">
                   ...
                   <!--  <div>
                      <b>Budget</b>
                      <div>₹ 1 Lakh - 5 Lakh</div>
                      <div>Or select from the ranges below</div>
                      <div>
                    ...
                    <div class="row">
                      ...
                      <div class="">
                        ...
                        <div class="col-md-6">
                           <h2>Maruti Dzire</h2>
                   <!--  <p>
                        <span class="badge badge-pill badge-warning">4.7</span> 
                        <span class="text-muted">291 Reviews</span>
                    </p> -->
