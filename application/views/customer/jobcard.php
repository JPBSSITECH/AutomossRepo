            ...
            <div class="col-xl-12">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body justify-content-between" style="padding: 8px 12px;">
                           <h2 style="padding-top:0px; margin-bottom:0px;" class="card-title">List Of Job Cards</h2>
                        ...
                        <tbody>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?= $r->bid_oount;  ?></td>
                                     <td>
                                        <a href="<?= base_url() ?>customer/jobcard_details/<?=$r->transaction_id ?>"   title="View Details">
