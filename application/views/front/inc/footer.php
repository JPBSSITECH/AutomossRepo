   <footer class="footer__section footer__bg5 footer__color--style text-white">
       <?php
            $u1 = $this->uri->segment(1);

            if($u1 == 'customer' || $u1 == 'mechanic'){
       ...
       <div class="footer__bottom">
           <div class="container">
               <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                   <p class="copyright__content"><span class="text__secondary">&copy; <?=date('Y') ?></span> Powered by
                       <a class="copyright__content--link" target="_blank"
                           href="https://deepak@strivesteam.com/">STRIVESTEAM PVT.LTD</a> . All Rights Reserved.
                   </p>
                                           ...
                                           <div class="product__media--preview__items">
                                               <a class="product__media--preview__items--link glightbox"
                                                   ...
                                                   href="assets/img/product/big-product/product1.webp"><img
                                                       ...
                                                       src="<?= base_url() ?>assets/img/product/big-product/product1.webp"
                                           ...
                                           <div class="product__media--preview__items">
                                               <a class="product__media--preview__items--link glightbox"
                                                   ...
                                                   href="assets/img/product/big-product/product2.webp"><img
                                                       class="product__media--preview__items--img"
                                                       src="<?= base_url() ?>assets/img/product/big-product/product2.webp"
                                                       alt="product-media-img"></a>
                                               <div class="product__media--view__icon">
                                                   <a class="product__media--view__icon--link glightbox"
                                           ...
                                           <div class="product__media--preview__items">
                                               <a class="product__media--preview__items--link glightbox"
                                                   ...
                                                   href="assets/img/product/big-product/product3.webp"><img
                                                       class="product__media--preview__items--img"
                                                       src="<?= base_url() ?>assets/img/product/big-product/product3.webp"
                                                       alt="product-media-img"></a>
                                               <div class="product__media--view__icon">
                                                   <a class="product__media--view__icon--link glightbox"
                                           ...
                                           <div class="product__media--preview__items">
                                               <a class="product__media--preview__items--link glightbox"
                                                   ...
                                                   href="assets/img/product/big-product/product4.webp"><img
                                                       class="product__media--preview__items--img"
                                                       src="<?= base_url() ?>assets/img/product/big-product/product4.webp"
                                                       alt="product-media-img"></a>
                                               <div class="product__media--view__icon">
                                                   <a class="product__media--view__icon--link glightbox"
                                           ...
                                           <div class="product__media--preview__items">
                                               <a class="product__media--preview__items--link glightbox"
                                                   ...
                                                   href="assets/img/product/big-product/product5.webp"><img
                                                       class="product__media--preview__items--img"
                                                       src="<?= base_url() ?>assets/img/product/big-product/product5.webp"
                                                       alt="product-media-img"></a>
                                               <div class="product__media--view__icon">
                                                   <a class="product__media--view__icon--link glightbox"
                               ...
                               <div class="product__media--nav swiper">
                                       ...
                                       <div class="swiper-slide">
                                           <div class="product__media--nav__items">
                                               <img class="product__media--nav__items--img"
                                                   src="<?= base_url() ?>assets/img/product/small-product/product1.webp"
                                                   alt="product-nav-img">
                                           </div>
                                       </div>
                                       <div class="swiper-slide">
                                           <div class="product__media--nav__items">
                                               <img class="product__media--nav__items--img"
                                                   src="<?= base_url() ?>assets/img/product/small-product/product2.webp"
                                                   alt="product-nav-img">
                                           </div>
                                       </div>
                                       <div class="swiper-slide">
                                           <div class="product__media--nav__items">
                                               <img class="product__media--nav__items--img"
                                                   src="<?= base_url() ?>assets/img/product/small-product/product3.webp"
                                                   alt="product-nav-img">
                                           </div>
                                       </div>
                                       <div class="swiper-slide">
                                           <div class="product__media--nav__items">
                                               <img class="product__media--nav__items--img"
                                                   src="<?= base_url() ?>assets/img/product/small-product/product4.webp"
                                                   alt="product-nav-img">
                                           </div>
                                       </div>
                                       <div class="swiper-slide">
                                           <div class="product__media--nav__items">
                                               <img class="product__media--nav__items--img"
                                                   src="<?= base_url() ?>assets/img/product/small-product/product5.webp"
                                                   alt="product-nav-img">
                                           </div>
                                       </div>
                                   </div>
                                   <div class="swiper__nav--btn swiper-button-next">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                           ...
                                           stroke-linecap="round" class=" -chevron-right">
                                   ...
                                   <div class="swiper__nav--btn swiper-button-prev">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                           viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                           stroke-linecap="round" class=" -chevron-left">
                                       ...
                                       <ul class="quickview__social--wrapper mt-0 d-flex">
                                           <li class="quickview__social--list">
                                               <a class="quickview__social--icon" target="_blank"
                                                   ...
                                                   <span class="visually-hidden">Facbook</span>
                                               </a>
                                           </li>
                                           <li class="quickview__social--list">
                                               <a class="quickview__social--icon" target="_blank"
...
.live--btn .gif-container {
    margin-right: 10px;
    animation: swingAndShrink 3s ease-in-out infinite;
}

.live--btn .gif-container img {
    width: 24px;
    height: auto;
    animation: swingAndShrink 3s ease-in-out infinite;
}
...
.live--btn .text span {
    ...
    animation: letterScale 1.5s ease-in-out infinite;
}

@keyframes swingAndShrink {
    0% {
...
/* Apply a random delay to each span for a staggered effect */
.live--btn .text span:nth-child(1) {
    animation-delay: 0s;
}

.live--btn .text span:nth-child(2) {
    animation-delay: 0.2s;
}

.live--btn .text span:nth-child(3) {
    animation-delay: 0.4s;
}

.live--btn .text span:nth-child(4) {
    animation-delay: 0.6s;
}

.live--btn .text span:nth-child(5) {
    animation-delay: 0.8s;
}

.live--btn .text span:nth-child(6) {
    animation-delay: 1s;
}

.live--btn .text span:nth-child(7) {
    animation-delay: 1.2s;
}

.live--btn .text span:nth-child(8) {
    animation-delay: 1.4s;
}

.live--btn .text span:nth-child(9) {
    animation-delay: 1.6s;
}

.live--btn .text span:nth-child(10) {
    animation-delay: 1.8s;
}

.live--btn .text span:nth-child(11) {
    animation-delay: 2s;
}

.live--btn .text span:nth-child(12) {
    animation-delay: 2.2s;
}
   </style>
   <?php  
$uz1 = $this->uri->segment(1);
if($uz1=='mechanic'){}else{
?>

   <a href="<?=base_url() ?>customer/jobcard_add" class="live--btn primary__btn">
       <div class="gif-container">
           <img src="<?= base_url() ?>assets/automoss_white.png" alt="Live Booking Icon">
       </div>
       <span class="text"><span>L</span><span>i</span><span>v</span><span>e</span>
           <span>B</span><span>o</span><span>o</span><span>k</span><span>i</span><span>n</span><span>g</span>
       </span>
   </a>
   <?php  
}
...
function ClickToSave(ids, ed_id) {
    ...
    var uu = '<?=base_url()?>admin/update_content';
   ...
   <script type="text/javascript" id="hs-script-loader" async defer src="//js-na1.hs-scripts.com/48807871.js"></script>
