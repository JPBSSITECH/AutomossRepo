                ...
                <nav class="navbar navbar-expand-lg bg-transparent">
                  <div class="container d-flex justify-content-evenly align-items-center" >
                    <ul class="header__topbar--info d-none d-lg-flex" style="margin-left: -127px;">
                        ...
                        <a class="navbar-brand d-flex justify-content-center" href="<?= base_url() ?>" style="height: 60px; width: 60px; background-color: #fff; margin-top: 10px; border-radius: 10px;">
                            <img src="<?= base_url() ?>fav.png?v=99" class="img-fluid" style="width: 50px">
                        </a>
                        <ul class="social__share style5 d-flex d-none d-lg-flex ms-4" style="float: right;">
