    ...
    <div class="container">
            ...
            <div class="login__section--inner">
                <div class="row row-cols-md-2 row-cols-1 d-flex justify-content-center">
                    ...
                    <div class="col">
                        <div class="account__login">
                            <div class="account__login--header mb-25">
                                <h2 class="account__login--header__title mb-10">Continue as a customer!</h2>
                            </div>
                  ...
                  if(!empty($err))
                  {
                      echo '<strong class="text-danger"> '.$err.'</strong>';
                  ...
                  ?>
                            ...
                            <div class="account__login--inner">
                                ...
                                <label>
                                    <input class="account__login--input" value="<?=@$_SESSION['uname'] ?>" name="uname"
                                        id="uname" placeholder="Enter Your Email Addres" type="email" required>
                                </label>
                                ...
                                <button class="custom-btn2 btn-12 hidden_div" id="verify"
                                   ><span>Click!</span><span>Verify</span></button>
                            ...
                            <p class="account__login--signup__text mt-5 text-end">Are You a Mechanic? <button
                                    type="submit"><a href="<?= base_url()?>mechlogin">Login Here</a></button></p>
...
function sendotp() {
    ...
    console.log('kkkkkkkkkkkkk===1', "<?=api_link ?>auth/customerlogin_init");


    // Make the POST API call
    $.ajax({
        url: "<?=api_link ?>auth/customerlogin_init",
        method: "POST",
...
document.getElementById("verify").addEventListener("click", function(event) {
    ...
    form.method = "POST";
    // form.action = "https://your-post-url.com";  
