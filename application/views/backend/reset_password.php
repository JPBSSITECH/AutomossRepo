                        ...
                        <div class="auth-full-page-content p-md-5 p-4" style="background-color: #daf3fa;">
                            <div class="w-100 p-5" >
                                ...
                                <div class="text-center">
                                        ...
                                        <h2 style="margin-top:20px; color: black;"><b>Reset Password</b></h2>
...
?> 
                                ...
                                <form method="post">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <label class="form-label" for="loginPassword">Password *</label>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" name="password" id="mypass"  class="form-control inp" minlength="8" placeholder="Enter Your Password" required/>
                                        ...
                                        <div class="row">                
                                            <div class="col-md-12">
                                                ...
                                                <label class="form-label" for="loginPassword">Repeat Password *</label>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" name="repeat_password" id="mypass2"  class="form-control inp" minlength="8" placeholder="Enter Your Password" required/>
                                                        <button  type="button" onclick="showpass2()" class="btn btn-secondary">
                                                        <i id="akhi2" class="fa fa-eye"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="submit" id="" class="form-control form-control-lg btn btn-primary submit" value="Change Password" />
                                        </div>
                                    
    
                                    <div  style="float: right;">
                                        
                                        <a href="<?= base_url('backend')?>">Log In </a>
                                    </div>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        function showpass2() {
          ...
          if (x.type === "password") {
            x.type = "text";
            $('#akhi2').attr( 'class','fa fa-eye-slash');
          } else {
            x.type = "password";
            $('#akhi2').attr( 'class','fa fa-eye');
          }
        }
    </script>
