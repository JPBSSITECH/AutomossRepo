                        ...
                        <div class="auth-full-page-content p-md-5 p-4" style="background-color: #daf3fa;">
                            <div class="w-100 p-5" >
                                ...
                                <div class="text-center">
                                        ...
                                        <h2 style="margin-top:20px; color: black;"><b>Forget Password</b></h2>
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="submit" id="" class="form-control form-control-lg btn btn-primary submit" value="Verify Your Email" />
                                        </div>
                                    
    
                                    <div  style="float: right;">
                                        
                                        <a href="<?=base_url('backend')?>">Login</a>
                                    </div>
