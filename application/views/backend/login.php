                        ...
                        <div class="auth-full-page-content p-md-5 p-4" style="background-color: #daf3fa;">
                            <div class="w-100 p-5" >
                                ...
                                <div class="text-center">
                                        ...
                                        <h2 style="margin-top:20px; color: black;"><b>Login</b></h2>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                     ...
                                                     <input type="email"  name="email"  id="email" class="form-control inp" placeholder="Enter Your Email"  required />
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="submit" id="" class="form-control form-control-lg btn btn-primary submit" value="Login" />
                                        </div>
                                    
    
                                    <div  style="float: right;">
                                        
                                        <a href="<?= base_url('backend/forget_password')?>">Forgot password?</a>
                                    </div>
