...
#mech_block {
    display: none;
    /* Mechanic block is hidden by default */
}
...
<div class="container">
    <div class="row">
        ...
        <h2 class="mb-6 ps-3 pt-2" style="border-left: 4px solid red;">Personal Information</h2>
                ...
                <form method="post" class="kyc_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <label class="contact__form--label" for="city_id">City</label>
                                <select class="contact__form--input" id="city_id" name="city_id">
                        ...
                        <div class="col-md-6">
                            <div class="contact__form--list mb-20">
                                ...
                                <input class="contact__form--input" name="pan_number" id="panNumber"
                                    onchange="validatePAN()" required placeholder="Ex: XXXXX1234X" type="text"
                                    maxlength="10" minlength="10" value="<?= @$info->pan_number ?>">
                    ...
                    <div id="garage_block">
                    <h2 class="mb-6 ps-3 pt-2" style="border-left: 4px solid red;">Shop Information</h2>
                        <div class="row">
                            <div class="col-md-4">
                            <div class="contact__form--list mb-20">
                            <label class="contact__form--label" for="garage_name">Shop Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="garage_phone">Shop Phone</label>
                            ...
                            <div class="col-md-4">
                                <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="garage_email">Shop Email</label>
                    ...
                    <h2 class="mb-6 ps-3 pt-2" style="border-left: 4px solid red;">Mechanic Information.</h2>
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 pb-4">
                            <h2 class="mb-3 ps-3 py-2" style="border-left: 4px solid red;">Select Product Category </h2>
                            <div class="checkbox-group">
...
checkboxes.forEach(checkbox => {
    checkbox.addEventListener('change', () => {
        ...
        if (checkedCount > <?=$pack->category_count ?>) {
            alert('You have selected max service category. To add more Upgrade Plan.');
