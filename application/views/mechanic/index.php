    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card bg-transparent" style="min-height: 120px;">
            	...
            	<div class="row mb-5">
				    ...
				    <div class="col-lg-3 col-md-6">
				        <div style="display: flex; align-items: center; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; background-color: #fff;">
				            <div style="width: 60px; height: 60px; border-radius: 50%; background-color: #ED1D24; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 24px;">
			    ...
			    <div class="col-md-4">
			      	<div class="card">
			      		<h3 class="text-start ms-3 mt-3 text-danger fw-bold">Quick Links</h3>
			      		<div class="card-body">
