...
<div class="row" style="margin-bottom: 20px;">
    ...
    border-radius: 10px;">
        ...
        <a style="float:left; margin-left:10px;"
            ...
            href="<?=base_url('mechanic/product_orders/active') ?>">Active</a>
        <a style="float:left; margin-left:10px;"
            class="wishlist_cart--btn <?=($typ == 'completed')?'animated_btn':'primary__btn_outlined ' ?>"
            href="<?=base_url('mechanic/product_orders/completed') ?>">Completed</a>

        <a style="float:left; margin-left:10px;"
            class="wishlist_cart--btn <?=($typ == 'cancelled')?'animated_btn':'primary__btn_outlined ' ?>"
            href="<?=base_url('mechanic/product_orders/cancelled') ?>">Cancelled</a>


        <a style="float:left; margin-left:10px;"
            class="wishlist_cart--btn <?=($typ == 'all')?'animated_btn':'primary__btn_outlined ' ?>"
            href="<?=base_url('mechanic/product_orders/all') ?>">All</a>
    </div>
</div>
    ...
    <div class="card shadow-lg" style="padding: 0;">
        ...
        <div class="card-body">
            <div class="cart__table">
                <table class="cart__table--inner" style="border-collapse: collapse; width: 100%;">
                    <thead class="cart__table--header">
                        <tr class="cart__table--header__items">
                            ...
                            <th class="cart__table--header__list ">Home Delivery</th>
                    ...
                    <tbody class="cart__table--body ">
                        ...
                        <tr class="cart__table--body__items">
                                ...
                                <div class="cart__product d-flex align-items-center">
                                    ...
                                    <div class="cart__content">
                                        <h3 class="cart__content--title h4"><a
                                                href="product-details.html"><?= $dd->product_name ?></a></h3>
                            ...
                            <td class="cart__table--body__list text-start">
                                <div style="font-size: 15px;"><?= $dd->sub_total ?></div>
                            </td>
                            <td class="cart__table--body__list text-start">
                                <div style="font-size: 15px;">
                                    <?php
                                                    echo ($dd->is_homedelivery == 1) ? "home delivery" : "No";
                                                    ?>
                            ...
                            <td class="cart__table--body__list text-right">
                                <a class="wishlist__cart--btn primary__btn"
                                    href="<?=base_url('mechanic/order_details/'.$dd->order_id)  ?>"><i
                                        class="fas fa-eye"></i></a>
                                <?php
                                                if ($dd->delivery_status == 1) {
                                                    // Show the same anchor tag for completed orders (or any different behavior you want for 'completed')
                                                    echo '<a target="bill" class="wishlist__cart--btn primary__btn" href="' . base_url() . 'product_bill/' . $dd->order_id . '"><i class="fas fa-file-invoice"></i></a>';
                                                }
                                            ?>
                            </td>
                        </tr>
