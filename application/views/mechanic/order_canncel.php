                ...
                <div class="card shadow-lg">
                    <div class="card-body d-flex justify-content-between align-items-center" style="padding: 8px 12px;">
                           <div class="d-flex" style="gap:10px;">
                               <h2 style="padding-top:0px; margin-bottom:0px;" class="card-title">Product Order Cancel</h2>
                    ...
                    <div class="row mt-4">
                         <div class="col-md-12">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label">Cancelation OTP <span class="contact__form--label__star"></span></label>
                                <input class="contact__form--input" name="otp" placeholder="Enter Otp" type="number">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label">Reason</label>
                                <input class="contact__form--input" name="reason" placeholder="Enter Reason of Cancelation" type="text">
                            </div>
                        </div>                      
                     </div>
